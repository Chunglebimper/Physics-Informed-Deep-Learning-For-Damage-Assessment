...
from datasetV2 import DamageDataset
...
def train_and_eval(use_glcm, patch_size, stride, batch_size, epochs, lr, root):
    ...
    train_generator = imagegen.flow_from_directory("../data/gt_post", class_mode="categorical",
    ...
    def get_key(val):
        for key, value in os.path.items():
            if val == value:
               return key
    ...
    X, y = make_classification(n_samples=train_size,
